...
export default class TeacherProfile extends Component {
    ...
    viewCourseInfo = () => {
        this.props.navigation.navigate('Teachermycourses')
        ...
        <ScrollView style={styles.Scroll}>
         ...
         <View style={styles.Body}>
                ...
                <View style={styles.innertextview}>    
                    ...
                    <Button  mode="text" onPress={this.viewNotification}>View Notices</Button>
                    </View>
                    <View style={styles.button}>
                    <Button  mode="text" onPress={this.writeNotices}>Write Notices</Button>
                    </View>
                    <View style={styles.button}>
                    <Button  mode="text" onPress={this.viewCourseInfo}>My Courses</Button>
                    </View>
                    <View style={styles.button}>
                    <Button  mode="text" onPress={this.viewProgress}>Students Progress</Button>
                    </View>
                    <View style={styles.button}>
                    <Button  mode="text" onPress={this.writeBlogs}>Write Blogs</Button>
                    </View>  
                </View>
          </View>
          </ScrollView>
