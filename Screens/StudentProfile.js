        ...
        />
         ...
         <View style={styles.Body}>
            ...
            <View style={styles.button}>
               <Button  mode="text" onPress={this.viewNotification}>View Notification</Button>
               </View>
               <View style={styles.button}>
               <Button  mode="text" onPress={this.viewCourseInfo}>View Course Information</Button>
               </View>
               <View style={styles.button}>
               <Button  mode="text" onPress={this.viewMarks}>View Marks</Button>
               </View>
               <View style={styles.button}>
               <Button  mode="text" onPress={this.viewBlogs}>View Blogs</Button>
               </View>
            </View>    
          </View>
          </ScrollView>
